%{
  ...
  # Deferred — tiers 6-10 (Junction, Relay, Hub, Spine, Grid) wire in with their keystone modules
  # as those districts land, after the Content Constitution pass on the names (§9). Tier 5 "Node"
  # landed with the Windlass (keystone: the signal_tap module in the Winder's Loft).
}
