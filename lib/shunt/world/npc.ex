defmodule Shunt.World.NPC do
  ...
  # TODO: add `contact_key: nil` field. It is the bare loyalty/identity key for a world NPC that
  # is also a Hub contact (e.g. "splice", "mother_graft"), decoupled from the district-prefixed
  # struct `id` (e.g. "liftworks_splice"). nil for ordinary world NPCs. The Hub reads loyalty via
