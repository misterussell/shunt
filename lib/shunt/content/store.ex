defmodule Shunt.Content.Store do
  ...
  @sources [
    ...
    # TODO: add `{:decks, "priv/content/decks"}` here. Decks are stat-bearing deck-hardware
    # items (plain %{id, name, slots, text} maps, id matches the inventory key) that define how
    # many program loadout slots the player has. Generic load_source/2 handles the map shape;
    # the dir may be empty until the seed lands (like :ice_nodes/:programs did).
