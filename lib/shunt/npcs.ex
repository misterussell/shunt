defmodule Shunt.Npcs do
  ...
  # NOTE: current_event/2 for story-driven world NPCs (e.g. the Tunnel Junkie) lives in
  # Shunt.World.Npcs, not here — this module (Shunt.Npcs) stays scoped to the five global
  # Fixer NPCs and the Hub UI. See lib/shunt/world/npcs.ex.
end
